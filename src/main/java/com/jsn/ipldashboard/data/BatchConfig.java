...
public class BatchConfig {
    ...
    @Bean
    public MatchDataProcessor processor() { // For each line in data csv file, processor will call MatchDataProcessor
                                            // which will convert MatchInput type to Match type we need.
    ...
    @Bean
    public Job importUserJob(JobCompletionNotificationListener listener, Step step1) { //Creating Job
    ...
    @Bean
    public Step step1(JdbcBatchItemWriter<Match> writer) { //Creating Step
